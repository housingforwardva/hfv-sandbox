...
# write_rds(state_ho_data, "state_ho_data.rds")
# write_rds(county_ho_data, "county_ho_data.rds")
# write_rds(tract_ho_data, "tract_ho_data.rds")
write_rds(tract_map_data, "tract_map_data.rds")
write_rds(va_counties, "va_co_shape.rds")
...
library(sf)
tract_map_data <- readRDS(here::here("tract_map_data.rds"))

tract_data_simplified <- tract_map_data |> 
  st_simplify(dTolerance = 0.001)

write_rds(tract_data_simplified, "tract_data_simplified.rds")
